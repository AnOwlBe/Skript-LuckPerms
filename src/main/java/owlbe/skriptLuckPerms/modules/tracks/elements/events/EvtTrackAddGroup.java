...
public class EvtTrackAddGroup extends SkriptEvent {
	...
	public static void register(SyntaxRegistry syntaxRegistry,EventValueRegistry eventValueRegistry) {
		...
		eventValueRegistry.register(EventValue.builder(OnTrackAddGroup.class, Group.class)
				.getter(OnTrackAddGroup::getGroup)
				.patterns("group")
				.build());

		eventValueRegistry.register(EventValue.builder(OnTrackAddGroup.class, Track.class)
