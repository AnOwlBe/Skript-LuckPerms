...
public class EvtGroupMetaRemove extends SkriptEvent {
	...
	public static void register(SyntaxRegistry syntaxRegistry,EventValueRegistry eventValueRegistry) {
		...
		eventValueRegistry.register(EventValue.builder(OnGroupMetaRemove.class, String.class)
		...
		eventValueRegistry.register(EventValue.builder(OnGroupMetaRemove.class, Group.class)
