...
public class EvtGroupMetaSet extends SkriptEvent {
	...
	public static void register(SyntaxRegistry syntaxRegistry,EventValueRegistry eventValueRegistry) {
		...
		eventValueRegistry.register(EventValue.builder(OnGroupMetaSet.class, String.class)
		...
		eventValueRegistry.register(EventValue.builder(OnGroupMetaSet.class, Group.class)
