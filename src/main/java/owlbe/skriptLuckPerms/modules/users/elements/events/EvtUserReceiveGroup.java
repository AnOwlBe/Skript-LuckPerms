...
public class EvtUserReceiveGroup extends SkriptEvent {
	...
	public static void register(SyntaxRegistry syntaxRegistry,EventValueRegistry eventValueRegistry) {
		syntaxRegistry.register(BukkitSyntaxInfos.Event.KEY, BukkitSyntaxInfos.Event.builder(EvtUserReceiveGroup.class, "User Receive Group")
				...
				.addPattern("[luckperm[s]] user receive group")
				.addDescription("""
		...
		eventValueRegistry.register(EventValue.builder(OnUserReceiveGroup.class, Group.class)
				.getter(OnUserReceiveGroup::getGroup)
				.patterns("group")
				.build());

		eventValueRegistry.register(EventValue.builder(OnUserReceiveGroup.class, Timespan.class)
