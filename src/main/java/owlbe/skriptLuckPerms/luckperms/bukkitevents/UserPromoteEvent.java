...
/**
 * Called when a {@link net.luckperms.api.model.user.User user} is promoted along a track.
 */
public class UserPromoteEvent extends UserEvent {

	private static final HandlerList HANDLER_LIST = new HandlerList();
	private final net.luckperms.api.event.user.track.UserPromoteEvent event;

	public UserPromoteEvent(OfflinePlayer player, net.luckperms.api.event.user.track.UserPromoteEvent event) {
		super(player);
		this.event = event;
	}
